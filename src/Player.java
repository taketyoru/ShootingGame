...
implements KeyListener{
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode()==KeyEvent.VK_SPACE) {
			GameWorld.playerBullets.add(new PlayerBullet(x,y,0,-10)); //GameWorld.playerBullets.add(new PlayerBullet(x,y,10,-10));練習問題10-2
			//GameWorld.playerBullets.add(new PlayerBullet(x,y,10,-10));　練習問題10-3
